/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc015/submissions/36095685
 * Submitted at: 2022-10-30 18:13:58
...
int main() {
  ...
  rep(turn, n * n - 1) {
    ...
    int choice = flavor[turn + 1];
    cout << choiceStr[choice] << endl;
  }
  return 0;
}