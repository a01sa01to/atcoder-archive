/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc012/submissions/32954428
 * Submitted at: 2022-07-03 15:50:12
 * Problem URL: https://atcoder.jp/contests/ahc012/tasks/ahc012_a
 * Result: AC
 * Execution Time: 2836 ms
 */
...
struct State {
  ...
  int calcScore() {
    ...
    return score = round((1e6 / double(den) * double(num)));
  }
  State neighbor() {
    State ret;
