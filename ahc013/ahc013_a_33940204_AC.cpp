/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc013/submissions/33940204
 * Submitted at: 2022-08-11 18:56:00
 * Problem URL: https://atcoder.jp/contests/ahc013/tasks/ahc013_a
 * Result: AC
 * Execution Time: 2864 ms
 */
    ...
    while (true) {
      ...
      rep(i, comp.size()) {
        ...
        for (auto d : dir) {
          ...
          if (cp[nxt.x][nxt.y].first == -100 - 100 * (!d.x) - cp[com.x][com.y].first) {
