/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc009/submissions/30421330
 * Submitted at: 2022-03-26 18:23:40
...
int main() {
  ...
  while (true) {  // Step2
    ...
    if (chrono::duration_cast<chrono::milliseconds>(now - start).count() > 1750) { break; }
