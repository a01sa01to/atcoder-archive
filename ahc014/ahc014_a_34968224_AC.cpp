/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/34968224
 * Submitted at: 2022-09-18 14:57:30
...
inline void connect(const int i, const int j, bool& flg) {
...
int main() {
  ...
  while (true) {
    ...
    if (chrono::duration_cast<chrono::milliseconds>(now - start).count() > 4925) break;
    int d = 0;
    bool flg = false;
    while (d <= n / 2) {
