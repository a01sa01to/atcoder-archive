/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29363392
 * Submitted at: 2022-02-16 12:20:39
...
// Step2: イッヌを閉じ込める
void step2() {
  if (canPlaceFence(Pt(30, 2), 0) && canPlaceFence(Pt(30, 29), 0)) {
    rep(i, m) {
