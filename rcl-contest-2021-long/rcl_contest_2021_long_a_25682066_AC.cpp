/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/rcl-contest-2021-long/submissions/25682066
 * Submitted at: 2021-09-08 12:51:37
 * Problem URL: https://atcoder.jp/contests/rcl-contest-2021-long/tasks/rcl_contest_2021_long_a
 * Result: AC
 * Execution Time: 1592 ms
 */
...
int main() {
  ...
  for (int MAX_CONSTANT_MACHINE = 1; MAX_CONSTANT_MACHINE <= 3; MAX_CONSTANT_MACHINE++) {
    for (int MAX_CONSTANT_NEXT_MACHINE = 5; MAX_CONSTANT_NEXT_MACHINE <= 40; MAX_CONSTANT_NEXT_MACHINE++) {
