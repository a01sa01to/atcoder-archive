/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc010/submissions/31227782
 * Submitted at: 2022-04-24 16:23:19
...
int main() {
  ...
  while (true) {
    ...
    if (bestScore < nextScore) {
      // if (bestScore < nextScore || random_double(0, 1) < exp((double) (nextScore - bestScore) / (elapsed / 2000.0))) {
      swap(ans, nxt);
      bestScore = nextScore;
    }
  }
