/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/abc271/submissions/35299489
 * Submitted at: 2022-10-01 21:49:40
...
ll dfs(int v, int goal, vector<vector<tuple<int, int, ll>>>& Graph, vector<bool>& visited, map<int, vector<int>>& e, int pl, ll cost) {
  if (v == goal) {
    return cost;
  }
  visited[v] = true;
