/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/abc245/submissions/30468295
 * Submitted at: 2022-03-26 22:06:57
...
int main() {
  int n, m;
  cin >> n >> m;
  vector<ll> a(n + 1), c(n + m + 1), b(m + 1, 0);
  rep(i, n + 1) cin >> a[i];
  rep(i, n + m + 1) cin >> c[i];
  // b[m] = c[m + n] - a[n];
