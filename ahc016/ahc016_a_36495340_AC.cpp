/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc016/submissions/36495340
 * Submitted at: 2022-11-14 19:45:08
...
int main(int argc, char* argv[]) {
  ...
  // Generate Graphs
  (eps == 0 ? GenerateGraphs0 : GenerateGraphs)();
