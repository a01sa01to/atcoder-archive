/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/future-contest-2022-qual/submissions/27018578
 * Submitted at: 2021-11-04 14:30:33
  ...
  void calcScore(ll1d& task_level, ll deltaDay) {
    ...
    rep(i, k) {
      if (deltaDay == 0) {
        ...
        scores_now[i] = (task_level[i] - at_least[i]) - deltaDay / k;
      }
    }
