/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/abc247/submissions/30888633
 * Submitted at: 2022-04-10 22:32:00
...
int main() {
  ...
  while (r < n) {
    ...
    if (l < r && (y == seg.prod(l, r + 1).first && seg.prod(l, r + 1).second == x)) l++;
  }
  cout << ans << endl;
  return 0;
}