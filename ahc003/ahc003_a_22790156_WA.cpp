/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc003/submissions/22790156
 * Submitted at: 2021-05-22 20:27:41
 * Problem URL: https://atcoder.jp/contests/ahc003/tasks/ahc003_a
 * Result: WA
 * Execution Time: 735 ms
 */
  ...
  loop(b,1000){
    ...
    while(x!=tx || y!=ty){
      ...
      if(y==ty && x>tx){ loop(c,x-tx){ res += "L"; x--; } }
        ...
        int bitLoop = min((ll)11, abs(x-tx)+abs(y-ty));
        loop(i,1<<bitLoop){
