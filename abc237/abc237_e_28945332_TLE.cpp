/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/abc237/submissions/28945332
 * Submitted at: 2022-01-30 22:12:17
...
void dfs(vector<set<int>>& Graph, int i, ll now, vector<bool>& visited, ll& ans, vector<ll>& h) {
  visited[i] = true;
  ans = max(ans, now);
  for (auto j : Graph[i]) {
