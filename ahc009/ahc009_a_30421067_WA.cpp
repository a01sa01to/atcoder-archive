/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc009/submissions/30421067
 * Submitted at: 2022-03-26 18:18:38
...
int main() {
  ...
  while (true) {  // Step2
    ...
    if (chrono::duration_cast<chrono::milliseconds>(now - start).count() > 1500) { break; }
