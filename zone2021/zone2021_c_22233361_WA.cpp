/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/zone2021/submissions/22233361
 * Submitted at: 2021-05-01 22:38:36
...
int main(){
  ...
  loop(i,upto10){ select[i+100] = people[i][0]; }
  sort(people.begin(),people.end(),[](vector<ull>& a, vector<ull>& b){ return a[3] > b[3]; });
  loop(i,upto10){ select[i+200] = people[i][0]; }
  ...
  loop(i,upto10){ select[i+400] = people[i][0]; }
