/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc013/submissions/33913966
 * Submitted at: 2022-08-10 12:33:12
 * Problem URL: https://atcoder.jp/contests/ahc013/tasks/ahc013_a
 * Result: WA
 * Execution Time: 2726 ms
 */
...
int main() {
  ...
  lab:
    rep(i, move.size()) rep(j, move.size()) {
      if (i >= j) continue;
