/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc009/submissions/30496175
 * Submitted at: 2022-03-27 11:09:46
...
inline double solveProb(const string& t, const vector<vector<Cell>>& wall, vector<vector<double>>& prob) {
  double per = 0;
  rep(turn, t.size()) {
...
inline double calcState(const string& t, const vector<vector<Cell>>& wall) {
