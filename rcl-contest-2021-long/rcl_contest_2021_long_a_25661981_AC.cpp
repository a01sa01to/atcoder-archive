/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/rcl-contest-2021-long/submissions/25661981
 * Submitted at: 2021-09-07 11:18:13
  ...
  rep(now, t) {
    ...
    if (matchVal.size() == 0) {
      ...
      if (Pos1.first == -1) {
        ...
        if (nowMachine <= MAX_CONSTANT_MACHINE * 2 && money >= needMoneyToBuy) {
