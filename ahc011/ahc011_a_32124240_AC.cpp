/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32124240
 * Submitted at: 2022-05-31 15:37:26
 * Problem URL: https://atcoder.jp/contests/ahc011/tasks/ahc011_a
 * Result: AC
 * Execution Time: 2903 ms
 */
...
int main() {
  ...
  do {
    auto [sc, s] = dfs("", 0, 0, min(12, t - int(ans.size())), x, y, nowScore);
    if (s.size() == 0) break;
    ReinitGrid(x, y, s);
    ans += s;
    swap(nowScore, sc);
