/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/future-contest-2022-qual/submissions/27012124
 * Submitted at: 2021-11-04 01:06:24
...
struct person {
  ...
  void calcScore(ll s) {
    ...
    score += 10 * max(0, 10 - int(scores.size()));
  }
...
int main() {
  ...
  while (true) {
    ...
    rep(_, t) {
      ...
      people[idx].task = 0;
      people[idx].calcScore(tasks[taskNum].level.sum(0, k) - k * (day - people[idx].startday + 1));
      rep(i, n) {
