/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32139427
 * Submitted at: 2022-06-01 13:54:35
 * Problem URL: https://atcoder.jp/contests/ahc011/tasks/ahc011_a
 * Result: AC
 * Execution Time: 2933 ms
 */
...
inline double calcScore(const string& input) {
  ...
  if (size == n * n - 1) {
    ...
    return (5e5 * double(size) / (n * n - 1) - 2 * d.groups().size());
  }
}
