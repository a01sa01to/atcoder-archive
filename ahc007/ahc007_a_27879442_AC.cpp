/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc007/submissions/27879442
 * Submitted at: 2021-12-12 19:23:05
...
ll euclidDist(P a, P b) {
  return ll(round(sqrt(ld((a.first - b.first) * (a.first - b.first) + (a.second - b.second) * (a.second - b.second))) * 1.1));
}
