/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32148436
 * Submitted at: 2022-06-01 23:26:34
 * Problem URL: https://atcoder.jp/contests/ahc011/tasks/ahc011_a
 * Result: AC
 * Execution Time: 2936 ms
 */
...
inline double calcScore(const string& input) {
  ...
  if (size == n * n - 1) {
    ...
    assert(s != 0);
    return (5e5 * double(size) / (n * n - 1) / s);
  }
}
