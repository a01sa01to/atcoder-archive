/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc003/submissions/23025023
 * Submitted at: 2021-05-30 15:22:46
 * Problem URL: https://atcoder.jp/contests/ahc003/tasks/ahc003_a
 * Result: AC
 * Execution Time: 993 ms
 */
...
ull3d Graph(30,ull2d(30,ull1d(4,1)));
  ...
  loop(b,1000){
    ...
    while(x!=tx || y!=ty){
      ...
      if(y==ty && x>tx){ loop(c,x-tx){ res += "L"; x--; } }
        ...
        int bitLoop = min((ll)12, abs(x-tx)+abs(y-ty));
        loop(i,1<<bitLoop){
