/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32153434
 * Submitted at: 2022-06-02 11:15:00
 * Problem URL: https://atcoder.jp/contests/ahc011/tasks/ahc011_a
 * Result: TLE
 * Execution Time: 3070 ms
 */
...
inline State ChokudaiSearch(State FirstState) {
  ...
  State maxim = HStates[t].top();
  rep(i, t) {
    if (HStates[i].top().score > maxim.score) {
      maxim = HStates[i].top();
    }
  }
  return maxim;
