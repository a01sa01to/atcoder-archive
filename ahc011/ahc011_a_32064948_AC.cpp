/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32064948
 * Submitted at: 2022-05-29 01:15:31
...
int main() {
  ...
  do {
    auto [sc, s] = dfs("", 0, 0, min(5, t - int(ans.size())), x, y, nowScore);
    if (s.size() == 0) break;
    ReinitGrid(x, y, s);
    ans += s;
    swap(nowScore, sc);
