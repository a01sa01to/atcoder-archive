/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/future-contest-2022-qual/submissions/27048486
 * Submitted at: 2021-11-06 12:04:21
        ...
        rep(i, n) {
          if (!tasks[i].finished && tasks[i].need.empty()) {
            ...
            if (pending_idx == -1) {
              ...
              if (tasks[i].sum_level / comp_est > tasks[pending_idx].sum_level / prev_est) {
                pending_idx = i;
              }
            }
          }
