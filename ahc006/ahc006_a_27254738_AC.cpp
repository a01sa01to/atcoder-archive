/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc006/submissions/27254738
 * Submitted at: 2021-11-14 17:33:54
...
void Annealing() {
  ...
  while (true) {
    try_cnt++;
    if (chrono::system_clock::now() - start > chrono::milliseconds(1500)) {
    ...
    // else {
    //   ld prob = exp(ld(bestState - nextState) / 1000);
