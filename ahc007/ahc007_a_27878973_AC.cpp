/*
 * Author: a01sa01to
 * Submission URL: https://atcoder.jp/contests/ahc007/submissions/27878973
 * Submitted at: 2021-12-12 19:11:56
...
ll euclidDist(P a, P b) {
  return ll(round(pow(1.1, sqrt(ld((a.first - b.first) * (a.first - b.first) + (a.second - b.second) * (a.second - b.second))))));
}
